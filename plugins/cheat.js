...
global.db.data.users[m.sender].premiumTime = 9574

global.db.data.users[m.sender].premiumDate = 9574

global.db.data.users[m.sender].lastbansos = 0

global.db.data.users[m.sender].lastkerja = 0

global.db.data.users[m.sender].lastrob = 0
