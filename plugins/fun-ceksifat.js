...
let handler = async (m, { conn, command, text }) => {
    ...
    let g = nm.getRandom();
    let h = nm.getRandom();
    let c = ['Baik Hati', 'Sombong', 'Pelit', 'Dermawan', 'Pencoli', 'Rendah Hati', 'Rendah Diri', 'Pemalu', 'Penakut', 'Pengusil', 'Cengeng'].getRandom();
    let d = ['Rajin', 'Malas', 'Membantu', 'Ngegosip', 'Jail', 'Gak jelas', 'Shoping', 'Chattan sama Doi', 'Chattan di WA karna Jomblo', 'Sedih', 'Kesepian', 'Coli', 'Mengaji', 'Bahagia'].getRandom();
