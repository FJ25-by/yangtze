...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `@${winner.split('@')[0]} Anda adalah pemenangnya 🎉 *+${winScore} XP*` : isTie ? `Game over, dengan hasil imbang *+${playScore} XP*` : `Sekarang giliran Anda ${['❎', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`} 
